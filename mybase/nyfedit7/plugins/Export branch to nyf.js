...
try{
	...
	if(xNyf.isOpen()){
		...
		var xInitFn = new CLocalFile(localStorage.getItem(sCfgKey)||''); xInitFn.append(_validate_filename(sItemTitle)||'untitled' + '.nyf');

		var sDbDst=platform.getSaveFileName(
			{ sTitle: plugin.getScriptTitle()
			, sInitDir: xInitFn
			, sFilter: 'myBase .nyf files (*.nyf);;All files (*.*)'
