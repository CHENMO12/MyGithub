...
try{
	...
	if(xNyf.isOpen()){
		...
		var vInputFields = [
			...
			, {sField: 'combolist', sLabel: _lc('p.Common.Range', 'Range'), vItems: vRange, nInit: localStorage.getItem(sCfgKey3)||''}
					...
					var vRecords = [];
					{
						...
						var _act_on_treeitem=function(sSsgPath, iLevel){
							...
							if(sPreferred){
								...
								var sTxt=xNyf.loadText(''+xSsgFn, 'auto');
