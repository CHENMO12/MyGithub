...
//sValidation=nyfjs
//sCaption=Insert row before
//sHint=Insert a row into the table before the current cell
//sCategory=/MainMenu.Table; /ToolBar.Table; ToolBar.Row
//sPosition=TBL-01-INS-00
//sCondition=CURDB; DBRW; CURINFOITEM; FORMATTED; EDITING; TABLE
//sID=p.Table.InsRowBefore
//sAppVerMin=7.0
//sShortcutKey=
//sAuthor=wjjsoft
	...
	if(xNyf.isOpen()){
		...
		if(!xNyf.isReadonly()){
			...
			if(plugin.isContentEditable()){
				//var sCode='insertRowBefore();';
				//plugin.runDomScript(-1, sCode);
				plugin.insertRowBefore();
			}else{
