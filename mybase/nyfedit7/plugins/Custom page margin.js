		...
		if(!xNyf.isReadonly()){
			if(plugin.isContentEditable()){
				...
				if(sEditor=='htmledit'){
					...
					var sTop0=plugin.getDocumentMargin(-1, 'margin-top'); //plugin.runDomScript(-1, 'cssUtil(document.body, "margin-top");')||'';
					var sRight0=plugin.getDocumentMargin(-1, 'margin-right'); //plugin.runDomScript(-1, 'cssUtil(document.body, "margin-right");')||'';
					var sBottom0=plugin.getDocumentMargin(-1, 'margin-bottom'); //plugin.runDomScript(-1, 'cssUtil(document.body, "margin-bottom");')||'';
					var sLeft0=plugin.getDocumentMargin(-1, 'margin-left'); //plugin.runDomScript(-1, 'cssUtil(document.body, "margin-left");')||'';
				...
				}else if(sEditor=='richedit' || sEditor=='textedit'){
