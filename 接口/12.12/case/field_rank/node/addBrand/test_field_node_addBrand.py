...
class TestNode(BaseCase):
    ...
    def test_field_node_addBrand(self, test_data):
        ...
        brandName = test_data["brandName"]
        ageGroups = test_data["ageGroups"]

        with allure.step("步骤: 请求接口"):

            res_json = api_object_admin.bns_node_addBrand(
